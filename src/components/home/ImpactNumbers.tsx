...
const AnimatedCounter: React.FC<AnimatedCounterProps> = ({
  ...
  return (
    <span className="font-poppins text-4xl sm:text-5xl lg:text-6xl font-bold text-green-primary">
      {count}
      {suffix}
    </span>
  );
...
export const ImpactNumbers: React.FC = () => {
  ...
  return (
    <section className="py-20 bg-[#e5f5eb]" ref={ref}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          {stats.map((stat, index) => (
            ...
            >
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-white text-[#b3a98a] mb-4 shadow-sm">
                {stat.icon}
              </div>
